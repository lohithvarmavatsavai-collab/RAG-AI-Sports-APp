#!/usr/bin/env python3
"""Generate the Colab notebook for the AI Sports RAG project."""
import json, os

def cell(cell_type, source, metadata=None):
    """Create a notebook cell."""
    c = {"cell_type": cell_type, "metadata": metadata or {}, "source": source if isinstance(source, list) else source.split("\n")}
    if cell_type == "code":
...
# ── Cell 1: Install ──
cells.append(cell("markdown", ["## 1. Install Dependencies"]))
...
cells.append(cell("markdown", ["## 4. Explore the Knowledge Base"]))
cells.append(cell("code", [
    "import pandas as pd\n",
    "\n",
...
# ── Cell 7: Single Query Demo ──
cells.append(cell("markdown", ["## 7. Demo: Single Query — RAG vs Baseline"]))
cells.append(cell("code", [
...
cells.append(cell("markdown", ["## 9. View Evaluation Results"]))
cells.append(cell("code", [
    "from IPython.display import Markdown, display\n",
    "\n",
...
cells.append(cell("markdown", ["## 10. Retrieval Precision Visualization"]))
cells.append(cell("code", [
...
cells.append(cell("markdown", ["## 12. Download Results"]))
cells.append(cell("code", [
    "from google.colab import files\n",
...
notebook = {
    ...
    "metadata": {
        "colab": {"provenance": [], "name": "AI_Sports_RAG_Pipeline.ipynb"},
...
out_path = "/Users/spartan/.gemini/antigravity/scratch/sports_rag_project/AI_Sports_RAG_Pipeline.ipynb"
